const CACHE_NAME = 'averian-pwa-v25';
...
self.addEventListener('fetch', (event) => {
  ...
  // Always bypass cache for version check endpoints
  if (url.pathname.includes('version.json') || url.pathname.includes('/api/version')) {
    return;
  }
